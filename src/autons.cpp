...
void negative_alliance_stake_rush(string c)
{
  ...
  chassis.turn_to_point(-71 * reversed, 0, 180);
...
void positive_goal_rush(string c)
{
  ...
  if (alliance == "blue")
  {
    ...
    chassis.drive_distance(40.4 - 1, 246.54);
    ...
    default_constants();
    chassis.turn_to_angle(155); // Tune this value to clamp on the goal
  }
  else
  {
    fast_exit_conditions();
    chassis.drive_distance(40.4 - 1, 66.54);
    Intake.spin(fwd, 100, pct);
  ...
  {
    default_constants();
    chassis.turn_to_point(20.304, -23.503, 180);
    chassis.drive_max_voltage = 5;
    chassis.drive_to_point(20.304, -23.503);
    Clamp.set(true);
    wait(200, msec);
    intakeSort = true;
  }
  ...
  chassis.drive_max_voltage = 12;
  chassis.turn_to_point(20.17 * reversed, 0);
  chassis.drive_to_point(20.17 * reversed, 0);
}
...
void auton_skills()
{
  ...
  // Align to wall stake
  chassis.turn_to_point(0, -41.202, 180);
  chassis.drive_to_point(6, -41.202); // wtf why is this 6 and why does this work ????
  ...
  chassis.turn_to_point(0 + 5, -69.388); // "off by theoretical" - Alex, physc kid
